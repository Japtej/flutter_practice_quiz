...
class QuizOverlay extends StatefulWidget{
  ...
  QuizOverlay(this._isCorrect, this._onTap);

  @override
  State createState() => new QuizOverlayState();
}

class QuizOverlayState extends State<QuizOverlay> with SingleTickerProviderStateMixin{
          ...
          children: <Widget>[
            new Container(
              ...
              child: new Transform.rotate(
                  ...
                  child: new Icon(widget._isCorrect == true ? Icons.done : Icons.cancel, size: _iconAnimation.value * 80.0)
              )
